...
namespace GUI
{
...

    {
        ...
        public struct Slice9
        {
            ...
            public Vector2 AA
            {
                get { return new Vector2(this.Outer.Left, this.Outer.Top); }

            }

            public Vector2 AB
            {
                get { return new Vector2(this.Inner.Left, this.Outer.Top); }

            }

            public Vector2 AC
            {
                get { return new Vector2(this.Inner.Right, this.Outer.Top); }

            }

            public Vector2 AD
            {
                get { return new Vector2(this.Outer.Right, this.Outer.Top); }
            ...
            public Vector2 BA
            {
                get { return new Vector2(this.Outer.Left, this.Inner.Top); }

            }

            public Vector2 BB
            {
                get { return new Vector2(this.Inner.Left, this.Inner.Top); }

            }

            public Vector2 BC
            {
                get { return new Vector2(this.Inner.Right, this.Inner.Top); }

            }

            public Vector2 BD
            {
                get { return new Vector2(this.Outer.Right, this.Inner.Top); }
            ...
            public Vector2 CA
            {
                get { return new Vector2(this.Outer.Left, this.Inner.Bottom); }

            }

            public Vector2 CB
            {
                get { return new Vector2(this.Inner.Left, this.Inner.Bottom); }

            }

            public Vector2 CC
            {
                get { return new Vector2(this.Inner.Right, this.Inner.Bottom); }

            }

            public Vector2 CD
            {
                get { return new Vector2(this.Outer.Right, this.Inner.Bottom); }
            ...
            public Vector2 DA
            {
                get { return new Vector2(this.Outer.Left, this.Outer.Bottom); }

            }

            public Vector2 DB
            {
                get { return new Vector2(this.Inner.Left, this.Outer.Bottom); }

            }

            public Vector2 DC
            {
                get { return new Vector2(this.Inner.Right, this.Outer.Bottom); }

            }

            public Vector2 DD
            {
                get { return new Vector2(this.Outer.Right, this.Outer.Bottom); }
            ...
            public int Top
            {
                get { return Inner.Top - Outer.Top; }
            }

            public int Bottom
            {
                get { return Outer.Bottom - Inner.Bottom; }
            }

            public int Left
            {
                get { return Inner.Left - Outer.Left; }
            }

            public int Right
            {
                get { return Outer.Right - Inner.Right; }
        ...
        public void RenderFrame(GraphicsDevice device, float X, float Y, float Width, float Height, Slice9? slice = null)
        {
            ...
            if (!slice.HasValue) slice = new Slice9(0, 0, 48, 48, 5, 5, 17, 5);
